About fig2dev-feedstock
=======================

Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/fig2dev-feedstock/blob/main/LICENSE.txt)
...
<table>
  ...
  <tr>
    ...
    <td>
      <details>
        <summary>
          <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=299&branchName=main">
            <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/fig2dev-feedstock?branchName=main">
          </a>
        </summary>
        <table>
          ...
          <tbody><tr>
              ...
              <td>
                <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=299&branchName=main">
                  <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/fig2dev-feedstock?branchName=main&jobName=linux&configuration=linux%20linux_64_" alt="variant">
                </a>
              </td>
            </tr><tr>
              <td>osx_64</td>
              <td>
                <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=299&branchName=main">
                  <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/fig2dev-feedstock?branchName=main&jobName=osx&configuration=osx%20osx_64_" alt="variant">
                </a>
              </td>
            </tr>
          </tbody>
...
Once the `conda-forge` channel has been enabled, `fig2dev` can be installed with `conda`:
...
```
mamba install fig2dev
```

It is possible to list all of the versions of `fig2dev` available on your platform with `conda`:
...
```
mamba search fig2dev --channel conda-forge
```
...
mamba repoquery search fig2dev --channel conda-forge

# List packages depending on `fig2dev`:
mamba repoquery whoneeds fig2dev --channel conda-forge

# List dependencies of `fig2dev`:
mamba repoquery depends fig2dev --channel conda-forge
```
